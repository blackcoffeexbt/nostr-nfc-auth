...
new Vue({
  ...
  data: function () {
    return {
      ...
      nfcTagReading: false,
      lnurlLink: `${window.location.host}/nostrnfcauth/api/v1/scan/`,
      cards: [],
      hits: [],
      refunds: [],
      cardDialog: {
  ...
  methods: {
    ...
    getCards: function () {
      ...
      LNbits.api
        .request(
          'GET',
          '/nostrnfcauth/api/v1/cards?all_wallets=true',
    ...
    getHits: function () {
      ...
      LNbits.api
        .request(
          'GET',
          '/nostrnfcauth/api/v1/hits?all_wallets=true',
          this.g.user.wallets[0].inkey
        )
        .then(function (response) {
    ...
    getRefunds: function () {
      ...
      LNbits.api
        .request(
          'GET',
          '/nostrnfcauth/api/v1/refunds?all_wallets=true',
          this.g.user.wallets[0].inkey
        )
        .then(function (response) {
    ...
    createCard: function (wallet, data) {
      ...
      LNbits.api
        .request('POST', '/nostrnfcauth/api/v1/cards', wallet.adminkey, data)
        .then(function (response) {
    ...
    updateCard: function (wallet, data) {
      ...
      LNbits.api
        .request(
          'PUT',
          '/nostrnfcauth/api/v1/cards/' + data.id,
          wallet.adminkey,
          data
        )
        .then(function (response) {
    ...
    enableCard: function (wallet, card_id, enable) {
      ...
      LNbits.api
        .request(
          'GET',
          '/nostrnfcauth/api/v1/cards/enable/' + card_id + '/' + enable,
          fullWallet.adminkey
        )
        .then(function (response) {
      ...
      LNbits.utils
        ...
        .onOk(function () {
          LNbits.api
            .request(
              'DELETE',
              '/nostrnfcauth/api/v1/cards/' + cardId,
