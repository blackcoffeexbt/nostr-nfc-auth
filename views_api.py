...
nostrnfcauth_api_router = APIRouter()


@nostrnfcauth_api_router.get("/api/v1/cards")
async def api_cards(
...
@nostrnfcauth_api_router.delete("/api/v1/cards/{card_id}")
...
@nostrnfcauth_api_router.get("/api/v1/hits")
async def api_hits(
...
@nostrnfcauth_api_router.get("/api/v1/refunds")
